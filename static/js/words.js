 ...
 * getSessionWords(lang, mode)           "default" → 50 words; "full" → all cells
...
const WORD_DATA = {
  ...
  da: [
    ...
    /* set 21 */ ["bag", "fag", "søg", "bøg", "sløj", "strøg", "støj", "steg", "dej", "kaj", "løg", "høj", "bag"],
    /* set 22 */ ["fangst", "angst", "bon", "gong", "gang", "lang", "hang", "tvang", "trang", "vrang", "syng", "gyng", "fangst"],
    /* set 23 */ ["bred", "brød", "grød", "græd", "bed", "ked", "led", "båd", "mod", "rod", "råd", "våd", "bred"],
    /* set 24 */ ["fjer", "fjor", "flor", "hær", "nær", "kær", "værd", "skur", "skyr", "glor", "bør", "hør", "fjer"],
    /* set 25 */ ["klods", "klok", "krudt", "kridt", "krat", "klat", "klit", "krav", "krog", "klog", "kløft", "kløgt", "klods"],
    /* set 26 */ ["trods", "trop", "trold", "drop", "dryp", "trak", "tryk", "trick", "drik", "drøn", "dræn", "dræb", "trods"],
    /* set 27 */ ["mål", "nål", "nøl", "march", "mark", "mast", "most", "nyd", "nys", "nat", "net", "mæt", "mål"],
    /* set 28 */ ["prins", "print", "brint", "fromt", "prompt", "bræk", "fræk", "frygt", "frugt", "brugt", "prik", "brik", "prins"],
    /* set 29 */ ["busk", "lusk", "husk", "krus", "knus", "brun", "brud", "brug", "brus", "pult", "sult", "fulgt", "busk"],
    /* set 30 */ ["rund", "bund", "lund", "duks", "buks", "gunst", "kunst", "flugt", "fluks", "spå", "små", "stå", "rund"],
  ...
  hi: [
    ...
    /* set 41 */ ["पुड़ा", "पुरी", "पुत्री", "पूर्ण", "पुटी", "पुण्य", "पूरी", "पुवा", "पुराज", "पुरा", "पृष्ठी", "पूनी"],
    /* set 42 */ ["पूँजी", "पूजा", "पूजाह", "पूता", "पूरक", "पूरब", "पूर्णार्", "पूतिर्", "पूवार्", "पूनी", "सूजा", "सूचा"],
    /* set 43 */ ["बंजर", "बंटी", "बंदर", "बंदी", "बंधी", "बंधू", "बंसी", "बंदा", "बंका", "बंधन", "लंका", "बाँका"],
    /* set 44 */ ["संगत", "संगम", "संगल", "संकल", "संकल्प", "संकर", "संकुल", "संगीत", "संगीन", "संकट", "संभल", "संवत"],
    /* set 45 */ ["सखी", "सख्ती", "सची", "सचल", "सड़न", "सतह", "सित", "सचन", "सदन", "सतल", "सजल", "सर्जन"],
    /* set 46 */ ["साकांक्ष", "साका", "सौदा", "साचार", "सादा", "सादर", "साधार", "सागर", "साया", "सारा", "साबर", "राका"],
    /* set 47 */ ["साक्षी", "साखी", "साझी", "साड़ी", "साथी", "साफी", "सिंधु", "सिंही", "सड़ी", "सिंधी", "साक्षर", "सिक्की"],
    /* set 48 */ ["रिक्ता", "रिक्षा", "रिहा", "रिता", "ऋची", "रेखा", "ऋचा", "ऋपा", "ऋहा", "ऋखा", "रेका", "रक्षा"],
    /* set 49 */ ["वजन", "वजह", "वतन", "वयन", "वर्जन", "वर्णन", "वर्ण", "वर्ष", "वलन", "वलय", "वक्ता", "वहन"],
    /* set 50 */ ["शिखर", "शिखा", "शिखी", "शिरा", "शिक्षा", "शिली", "शैली", "इला", "सिखा", "शिला", "शूली", "शिमी"]
  ],
  ru: [
    ...
    /* set 03 */ ["лоза", "ложа", "лыжа", "грыжа", "луна", "лужа", "лупа", "лежа", "лежка", "ложе", "ложка", "лето"],
    /* set 04 */ ["слива", "слава", "слева", "слеза", "слезать", "скала", "сливать", "слинять", "слово", "лира", "лиса", "липа"],
    ...
    /* set 07 */ ["мерить", "месить", "весить", "верить", "варить", "парить", "шарить", "шалить", "палить", "долить", "солить", "сорить"],
    ...
    /* set 16 */ ["доход", "поход", "проход", "залёт", "прихоть", "уход", "урод", "урал", "уран", "буран", "заход", "завод"],
    /* set 17 */ ["позор", "дозор", "донор", "донос", "довод", "повод", "овод", "овощ", "обод", "обед", "обрить", "обить"],
    ...
    /* set 24 */ ["дуга", "дума", "душа", "кума", "куда", "руда", "груда", "грудка", "грядка", "кулек", "кулак", "сумма"],
    ...
    /* set 28 */ ["прокол", "прикол", "покой", "покос", "помост", "помол", "помочь", "помощь", "помет", "помесь", "молить", "полет"],
    ...
    /* set 33 */ ["повар", "пожар", "товар", "токарь", "топот", "словно", "тополь", "топка", "стопка", "томить", "точить", "мочить"],
    ...
    /* set 42 */ ["побыть", "помыть", "помять", "побить", "пробить", "забыть", "залить", "залив", "забить", "запить", "зажить", "зажим"],
    /* set 43 */ ["заря", "заряд", "наряд", "народ", "надуть", "надеть", "задеть", "задуть", "забыть", "зарыть", "заржать", "зажать"],
    /* set 44 */ ["белить", "делить", "острить", "остричь", "селить", "остро", "острог", "остров", "отбить", "обить", "обвить", "обжить"],
    ...
    /* set 47 */ ["щедро", "ведро", "бедро", "бодро", "это", "эхо", "ухо", "этот", "этап", "этаж", "исток", "итог"],
  ...
  el: [
    ...
    /* set 15 */ ["σκόνη","λιώνει","χώνει","πόλη","κάνει","χάνει","ψάχνει","ζώνη","χάλι","χαλί","ζουμί","ζωή"],
    ...
    /* set 24 */ ["λαός","ναός","νομός","βωμό","σωρός","νεκρός","ωμό","μικρός","κακός","χαζός","χορός","χοντρός"],
    /* set 25 */ ["πύργος","πάγος","ρίγος","πάτος","βάθος","πάχος","λόγος","τζόγος","βράχος","βάζο","κάδο","μπάζα"],
    /* set 26 */ ["μοχλός","στολή","σχολή","χολή","τιμή","τομή","πνοή","όχλος","πόλος","ρόλος","στόλος","βολή"],
    ...
    /* set 39 */ ["φάρμα","ξηρά","άλμα","άσμα","φάσμα","χάσμα","χάρμα","σφάλμα","σχάρα","σφαίρα","χαρά","σειρά"],
    /* set 40 */ ["σόγια","σκάγια","σκάκι","τζάκι","τζάμι","γκάζι","μπάζει","στάζει","βράζει","φτάνει","φτύνει","πλάγια"],
    /* set 41 */ ["άλσος","κάρο","κάλος","κάσα","κάρτα","μάζα","μάνα","πάσο","μπάσο","μάγκας","μίζα","πρίζα"],
    /* set 42 */ ["μπαμπάς","παπάς","φοράς","ρωτάς","χαλάς","χρωστάς","ψαράς","τυρί","σφυρί","τυφλή","ζητάς","κοιτάς"],
